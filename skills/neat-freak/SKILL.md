...
description: >
  ...
  "clean up docs", "/sync", "/neat", "同步一下", "整理文件", "整理一下", "更新記憶", "階段完成"
  or any phrase suggesting a dev milestone where knowledge needs reconciliation. 
  Also trigger when the user reports stale docs, conflicting memories, or wants a clean handoff to teammates or other agents.
  Bare "tidy" with prior dev context counts — do not under-trigger.
