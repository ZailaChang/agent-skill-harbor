...
For VS Code with SSH Remote or local: see [docs/vscode-copilot-setup.md](docs/vscode-copilot-setup.md) for the full setup including user `settings.json` configuration and the `setup skills` bootstrap flow.
